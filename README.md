...
```bash
# 推奨: 環境に合わせて自動選択
docker pull ghcr.io/smkwlab/texlive-ja-textlint:2026e
...
```bash
# 推奨: 環境に合わせて自動選択
$ docker run --rm -it -v $PWD:/workdir ghcr.io/smkwlab/texlive-ja-textlint:2026e \
